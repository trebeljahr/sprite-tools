...
// Top-of-page nav. Split from layout.tsx into its own client component so
// the layout itself can stay a server component (required for exporting
// `metadata` for OG / favicons / social previews).
